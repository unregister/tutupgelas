...
<div class="box-header">
	<h3 class="box-title"><i class="fa fa-pencil-square-o"></i> <?php echo $this->l('form_edit'); ?> <?php echo $subject?></h3>
</div>
<div class="box-body">
	<div id="message-box" class="span12"></div>
	<?php echo form_open( $update_url, 'method="post" id="crudForm" class="form-div span12" autocomplete="off" enctype="multipart/form-data"'); ?>
...
<div class="box-footer text-right">
	<button type="button"  class="btn btn-large btn-primary submit-form">
    	<i class="fa fa-floppy-o"></i> <?php echo $this->l('form_update_changes'); ?>
    </button>
    <?php 	if(!$this->unset_back_to_list) { ?>
    <button type="button" id="save-and-go-back-button" class="btn btn-large btn-primary">
		<i class="fa fa-share-square-o"></i> <?php echo $this->l('form_update_and_go_back'); ?>
    </button>
