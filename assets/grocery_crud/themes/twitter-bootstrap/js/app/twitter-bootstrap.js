...
function confirmationModalDialog(title_modal, message_text){
	...
	var modal_content = '<div id="dialog_modal_message" class="modal fade"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><h4 class="modal-title">' + title_modal + '</h4></div><div class="modal-body">'+ message_text + '</div><div class="modal-footer"><button type="button" class="btn btn-default cancel-confirmation" data-dismiss="modal">Batal</button><button type="button" class="btn btn-primary ok-confirmation" onclick="javascript:forceDelete();">Ok</button></div></div></div></div>';
...
{
	var url = $('#dialog_modal_message').find('button.ok-confirmation').data('target-url');
